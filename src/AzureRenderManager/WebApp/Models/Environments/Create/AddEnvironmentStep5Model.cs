...
{
    public class AddEnvironmentStep5Model : EnvironmentBaseModel
    {
        // needs this empty constructor for model bindings
        public AddEnvironmentStep5Model() { }

        public AddEnvironmentStep5Model(RenderingEnvironment environment)
        {
