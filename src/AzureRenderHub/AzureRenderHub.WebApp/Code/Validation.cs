    ...
    public static class Validation
    {
        public static class Errors
        {
            public static class Regex
            {
                ...
                public const string Subnet = "Subnet names only allow alphanumeric characters, periods, underscores, and hyphens and cannot end in a period.";
        ...
        public static class RegularExpressions
        {
            ...
            public const string CidrSubnetRange = @"^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])(\/(3[0-2]|[1-2][0-9]|[0-9]))$";
        }
