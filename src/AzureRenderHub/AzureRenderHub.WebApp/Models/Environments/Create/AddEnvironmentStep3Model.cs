...
{
    public class AddEnvironmentStep3Model : EnvironmentBaseModel
    {
        private const string DefaultKeyVaultCertName = "RenderHubKeyVaultSPCert";

        // needs this empty constructor for model bindings
        public AddEnvironmentStep3Model() { }
